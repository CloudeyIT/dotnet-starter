...
[Guard(new[] { Admin })]
public class Role : IdentityRole<Ulid>, IEntity
{
	...
	public class Configuration : IEntityTypeConfiguration<Role>
	{
		public void Configure (EntityTypeBuilder<Role> builder)
		{
			builder.HasData(
				new Role
				{
					Id = new Ulid(Guid.Parse("e4cfb454-89bb-47bc-854a-515ad7fa67f7")),
					Revision = new Ulid(Guid.Parse("7be7db8d-770d-4050-ba1c-c19f82a21714")),
				...
				new Role
				{
					Id = new Ulid(Guid.Parse("8523a77d-c182-428b-ab78-edcf96a84b28")),
					Revision = new Ulid(Guid.Parse("867de9c0-fcad-42de-883b-7f2e9a988338")),
